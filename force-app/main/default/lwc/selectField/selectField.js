...
import getObjects from '@salesforce/apex/MyUtility.getObjects';
import exportCSV from '@salesforce/apex/MyUtility.exportCSV';
import saveRecord from '@salesforce/apex/SelectFieldsController.saveRecord';

import AUDIO_RESOURCE from '@salesforce/resourceUrl/audio';
import VIDEO_RESOURCE from '@salesforce/resourceUrl/video';
...
export default class SelectFields extends LightningElement {
    ...
    //audioSource = 'https://cloudcentricinfotech-d-dev-ed.my.salesforce.com/sfc/p/5i000008BHCz/a/5i000000URUo/tl3VFYvVgQGk_iKEVQHKYCYvXJ.L2KySir5T1DsDJOk';
    ...
    videoSource = VIDEO_RESOURCE;

    data = [
    { label: 'Example 1', url: 'https://example.com' , name : 'asd'},
    { label: 'Example 2', url: 'https://example.org' , name : 'asdfasfd' },
    // ... other data
];
...
columns = [
    ...
    { label: 'URL', fieldName: 'url', type: 'url', typeAttributes: { label: { fieldName: 'name' } } },
    // ... other columns
];
